 ...
 * @copyright  (C) 2011-2014 Gregor Anzelj, gregor.anzelj@gmail.com
 *
 */
        ...
        $elements['apikey'] = array(
            ...
            'elements' => array(
                'embedlysiteapikeydesc' => array(
					'type'  => 'html',
                    'value' => get_string('apikeydescription','blocktype.embedly', '<a href="https://app.embed.ly/login" target="_blank">', '</a>')
                ),
